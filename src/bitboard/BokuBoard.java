   ...
   implements BoardType
 {
   ...
   public final synchronized Field[] getCaptureFields(int x, int y, int colour)
   {
     ...
     if (colour == 1) {
       ...
       sandwichMask = 393225 << fieldConst.get_xA(); else {
       return null;
     }
     int lineView = this.viewA[fieldConst.get_yA()];
   ...
   public synchronized int evalBoard()
   {
     ...
     for (int line = 0; line < this.viewA.length; line++) {
       ...
       do
       {
         eval += rowEvalA(rowN, line);rowN++;this.map.getClass();
     ...
     for (int line = 0; line < this.viewB.length; line++) {
       ...
       do
       {
         ...
         eval += rowEvalC(rowN, line);rowN++;this.map.getClass();
   ...
   public synchronized Field[] getWinnerFields(int x, int y, int colour)
   {
     ...
     if (colour == 1) {
       ...
       do {
         ...
         rowN++;this.map.getClass(); } while (rowN <= this.map.lineLength[0][lineA] - 5);
       ...
       if (!winnerFound) {
         ...
         do {
           ...
           rowN++;this.map.getClass(); } while (rowN <= this.map.lineLength[1][lineB] - 5);
       }
       ...
       if (!winnerFound) {
         ...
         do {
           ...
           rowN++;this.map.getClass(); } while (rowN <= this.map.lineLength[2][lineC] - 5);
   ...
   public String toString()
   {
     ...
     for (int n = 0; n < this.map.numberOfFields; n++) {
       if (this.map.firstInLine(n)) {
         ...
         int i = 0;
         do {
           returnStr = returnStr + "  ";i++;this.map.getClass();
