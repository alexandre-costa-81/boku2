  ...
  public abstract class BokuEngine
    extends EngineType
  {
    ...
    public String toString()
    {
      return 
        ...
        getID() + " (" + this.maxPly + " ply, random " + (this.randomChoice ? "on" : "off") + ")";
    }
  }
